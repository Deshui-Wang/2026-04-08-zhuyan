...
const productsData = {
  '基座系统': [
    {
      ...
      icon: Workflow,
      link: 'https://cloudmind.cailian.net/',
      stats: '弹性算力调度',
      color: '#475569',
    },
    {
  ...
  '智能助研': [
    ...
    },
    {
      ...
      icon: Kanban,
      link: 'https://xiangmu.cailian.net',
      stats: '实时智能管控',
      color: '#0ea5e9',
    },
    {
  ...
  '智能助教': [
    ...
    },
    {
      ...
      icon: MessageSquare,
      link: 'https://zlprompt.cailian.net/',
      stats: '实战技能提升',
      color: '#8b5cf6',
    },
    {
      ...
      icon: FileSearch,
      link: 'https://teachertree.cailian.net',
      stats: '数字化成长足迹',
      color: '#8b5cf6',
    },
    {
    ...
    },
    {
      ...
      icon: GraduationCap,
      link: 'https://xueqingfenxi.lhrj.cn',
      stats: '因材施教决策',
      color: '#8b5cf6',
    }
  ],
  '智能伴学': [
    ...
    },
    {
      ...
      icon: HeartPlus,
      link: 'https://qingtian.cailian.net',
      stats: '全天候心理支持',
      color: '#ec4899',
    },
    {
    ...
    },
    {
      ...
      icon: Kanban,
      link: 'https://studentspace.cailian.net/',
      stats: '云端智慧空间',
      color: '#ec4899',
    },
    {
  ...
  '智能就业': [
    ...
    },
    {
      ...
      icon: Video,
      link: 'https://monimianshi.cailian.net/',
      stats: '专家级面试陪跑',
      color: '#f59e0b',
    },
    {
